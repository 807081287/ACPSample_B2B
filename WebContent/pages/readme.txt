...
3) 测试界面中的交易时一定要先配置好私钥签名证书，验签公钥证书。
                                                     ...
                                                     全渠道代付产品消费交易示例地址为：http://IP：端口/ACPSample_B2B
───────────
...
ACPSample_B2B
  ...
  │  │  ├DemoBase.java┈┈┈┈┈基础类	
  │  │  │	
  │  │  ├Form02_6_2_FrontConsume.java┈┈┈┈┈跳转银联页面选择银行网银消费示例	
  │  │  │	
  │  │  ├Form02_6_3_Refund.java┈┈┈┈┈退货交易		
  │  │  │
  │  │  ├Form02_6_4_Query.java┈┈┈┈┈交易状态查询交易
  │  │  │
  │  │  ├Form02_7_FileTransfer.java┈┈┈┈┈文件传输交易（对账文件下载）
  │  │  │
...
1.【接口规范】该接口参考文档位置：
      接口产品规范：open.unionpay.com帮助中心 下载  产品接口规范  《b2b产品接口规范》
